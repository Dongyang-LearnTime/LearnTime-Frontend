...
export function ScheduleHeader({ onOpenAddModal }: ScheduleHeaderProps) {
  return (
    <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 studio-card glow-indigo">
      ...
      <div>
        <h2 className="text-3xl sm:text-4xl font-black tracking-tight mb-2 border-l-8 border-indigo-600 pl-6 text-gray-900 dark:text-white">일정 관리</h2>
        <p className="text-gray-500 dark:text-gray-400 font-medium text-lg ml-2">나만의 루틴과 중요한 일정들을 체계적으로 관리하세요.</p>
      </div>
