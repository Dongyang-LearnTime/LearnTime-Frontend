import { SparklesIcon, ClockIcon, ActivityIcon } from '../../../components/ui/Icons';

// Gemini AI가 일정 데이터와 주변 조건(교통, 기상 등)을 연산하여 추천/알림을 띄우는 컴포넌트
export function AiInsightsBox() {
  return (
    <section className="relative overflow-hidden studio-card p-0! border-none bg-linear-to-r from-indigo-600/10 via-purple-500/10 to-indigo-600/10 dark:from-indigo-500/20 dark:via-purple-500/20 dark:to-indigo-500/20">
      {
        // 배경 블러 데코레이션
      }
      ...
      <div className="relative p-6 md:p-8 flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="w-16 h-16 bg-linear-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-indigo-500/30 shrink-0 animate-pulse">
