...
export function DietBox() {
  ...
  return (
    <Card className="flex flex-col h-full glow-rose border-t-4 border-rose-500 min-h-162.5">
      ...
      <div className="flex flex-col gap-2 mb-8">
        ...
        <div className="flex gap-2">
          <input type="number" value={amount} onChange={e => setAmount(e.target.value)} placeholder="중량 (g)" className="grow bg-gray-50 dark:bg-[#050505] border border-gray-100 dark:border-[#1a1a1a] rounded-xl px-4 py-3 text-sm font-bold outline-none focus:ring-2 focus:ring-rose-500 transition-all" />
