      ...
      <div className="max-w-7xl mx-auto px-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {GAMIFICATION_ITEMS.map((item, i) => (
            <div
              key={i}
              className="reveal-content card-3d-hover group p-8 rounded-[2.5rem] border border-white/10 bg-white/4 backdrop-blur-xl hover:bg-white/8 hover:border-white/20 transition-all duration-500"
