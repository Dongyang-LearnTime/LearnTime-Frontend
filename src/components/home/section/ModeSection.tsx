      ...
      <div className="max-w-7xl mx-auto px-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {MODES.map((mode, i) => (
            <div
              key={i}
              className={`reveal-content card-3d-hover group p-10 bg-white/4 backdrop-blur-xl border ${mode.color} border-opacity-30 rounded-[3rem] hover:bg-white/8 transition-all duration-500 relative overflow-hidden`}
